...
Spanish only, no [EN]/[ES] and no Transcription credit. Skill names stay English.
...
item.SYSTEM_PROMPT = """
You are an expert video game localizer. Translate TERA MMORPG item bonus lines from French to Latin American Spanish. The source is French. Write Spanish only. Write HP and MP, never PV or PM.
