...
Spanish only, same rules as UI. Unicode accents (hash is color, never &#).
...
item.SYSTEM_PROMPT = """
You are an expert video game localizer. Translate TERA MMORPG NPC menu labels from French to Latin American Spanish.

These are the short buttons a player sees when talking to an NPC: Learn Skills, Expand Inventory, Shop, Bank, Create Guild, Travel. Translate the visible meaning into natural Latin American Spanish. Return ONLY the Spanish text. The script saves Spanish only. Write HP and MP, never PV or PM.
