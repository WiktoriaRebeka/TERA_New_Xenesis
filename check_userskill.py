...
ATTRS_TO_KEEP = ("id", "gender", "race", "class")
...
def main() -> int:
    ...
    for entry in entries:
        ...
        source_tip = source_by_key.get(identifier, {}).get("tooltip", "")
        english, spanish = source_tip, tooltip

        if source_tip and engine_vars(english) != engine_vars(spanish):
